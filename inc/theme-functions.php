...
if ( ! function_exists( 'gotham_get_exclude_displayed_post_ids' ) ) :
	...
	function gotham_get_exclude_displayed_post_ids() {
		...
		if ( empty( $gotham_exclude_displayed_post_ids ) ) {
		...
		return $gotham_exclude_displayed_post_ids;
	}
endif;
